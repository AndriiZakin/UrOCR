...
def main(image_file, tess_args):
    ...
    if not tess_args:
        #d = os.path.dirname(sys.modules["UrOCR"].__file__)
        #tessdata_dir = os.path.join("UrOCR" ,"OCR", "tessdata")
        tessdata_dir = r'C:/Users/AndrZ/Desktop/Comp.SienceProject/UrOCR/OCR/tessdata'
